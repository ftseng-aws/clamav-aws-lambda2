...
do
  ...
  echo "[${LAMBDA_EXTENSION_NAME}] Scanning ... using clamdscan $(clamdscan --log=/mnt/fs1/scanlogs/clamdscan-gamma.log --config-file=/opt/bin/scan.conf /mnt/fs1/scan/ > /mnt/fs1/scanlogs/scanresults-gamma.txt)"
  echo "[${LAMBDA_EXTENSION_NAME}] Scanresults copying to S3 ... $(aws s3 cp /mnt/fs1/scanlogs/scanresults-gamma.txt s3://avscan-scanlogsbucket-106089044578/gamma/scanresults-gamma.txt)"
  echo "[${LAMBDA_EXTENSION_NAME}] Clamdscan-gamma copying to S3 ... $(aws s3 cp /mnt/fs1/scanlogs/clamdscan-gamma.log s3://avscan-scanlogsbucket-106089044578/gamma/clamdscan-gamma.log)"
  # echo "[${LAMBDA_EXTENSION_NAME}] Copying scanresults.txt logs into efs $(cp /tmp/scanresults-gamma.txt /mnt/fs1/scanlogs/scanresults.txt)"
  # echo "[${LAMBDA_EXTENSION_NAME}] Copying clamdscan logs into efs $(cp /tmp/clamdscan-gamma.log /mnt/fs1/scanlogs/clamdscan.log)"
